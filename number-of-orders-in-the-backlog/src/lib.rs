...
impl Solution {
    pub fn get_number_of_backlog_orders(orders: Vec<Vec<i32>>) -> i32 {
        ...
        let mut sell_heap: BinaryHeap<Reverse<Orders>> = BinaryHeap::new(); // Reverse<Orders>
        ...
        for order in orders {
            ...
            if is_buy {
                while let Some(sell_orders) = sell_heap.pop() {
                ...
                while let Some(buy_orders) = buy_heap.pop() {
